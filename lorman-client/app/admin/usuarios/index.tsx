...
import { listUsers, register, updateUser } from '@/api/users';
              ...
              <CardContent className="p-6">
                <View className="flex-row items-start justify-between">
                  <View className="flex-1 gap-3">
                    <View className="flex-row items-center gap-2">
                      <View
                        className={`h-10 w-10 items-center justify-center rounded-full ${usuario.rol === 'admin' ? 'bg-purple-500' : 'bg-blue-500'}`}>
                      ...
                      <View>
                        ...
                        <View
                          className={`rounded-full px-2 py-1 ${usuario.rol === 'admin' ? 'bg-purple-100' : 'bg-blue-100'}`}>
                          <Text
                            className={`text-xs font-semibold ${usuario.rol === 'admin' ? 'text-purple-700' : 'text-blue-700'}`}>
                    ...
                    <View className="gap-2">
                      ...
                      <Text className="mt-2 text-xs text-gray-500">
                        Registrado: {new Date(usuario.fecha_registro).toLocaleDateString('es-MX')}
                      </Text>
                    </View>
                  </View>
                  ...
                  <View className="flex-row gap-2">
                    ...
                    <Pressable
                      onPress={() => handleDeleteUser(usuario.id_usuario, usuario.nombre_completo)}
          ...
          <View className="mt-6 flex-row items-center justify-between">
            ...
            <View className="flex-row items-center gap-2">
              <Pressable
                ...
                className={`flex-row items-center gap-1 rounded-lg px-3 py-2 ${currentPage === 1 ? 'bg-gray-100' : 'border border-gray-300 bg-white'}`}>
              ...
              <Pressable
                ...
                className={`flex-row items-center gap-1 rounded-lg px-3 py-2 ${currentPage === totalPages ? 'bg-gray-100' : 'border border-gray-300 bg-white'}`}>
                <Text
