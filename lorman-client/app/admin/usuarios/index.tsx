...
export default function UsuariosScreen() {
  ...
  const handleEditUser = (usuario: Usuario) => {
    console.log('Editar usuario:', usuario.id_usuario);
  };
                        ...
                        <View
                          ...
                          <Text
                            className={`text-xs font-semibold ${
                              usuario.rol === 'admin' ? 'text-purple-700' : 'text-blue-700'
                            }`}>
